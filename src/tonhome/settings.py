"""
Django settings for tonhome project.
...
ROOT_URLCONF = "tonhome.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [BASE_DIR / "templates", BASE_DIR / "tonhome"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "tonhome.wsgi.application"
...
LOGIN_REDIRECT_URL = "/"
ACCOUNT_AUTHENTICATION_METHOD = "username_email" # username_email if you want either
ACCOUNT_EMAIL_VERIFICATION="optional"
ACCOUNT_EMAIL_SUBJECT_PREFIX="[TON]"
